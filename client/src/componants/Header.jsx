  ...
  return (
    <header className="bg-slate-200 shadow-md">
      <div className="flex justify-between items-center max-w-6xl mx-auto p-3">
        <Link to="/">
          <h1 className="font-bold-italic text-sm sm:text-xl flex flex-wrap">
            <span className="text-slate-500">Housing</span>
            <span className="text-slate-800">Pune</span>
          </h1>
        </Link>
        <form className="bg-slate-200 p-3 rounded-lg flex items-center">
          <input
            type="text"
            placeholder="Search.."
            className="bg-transperant focus:outline-none w-24 sm:w-64"
          />
